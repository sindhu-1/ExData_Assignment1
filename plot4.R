...
par(mfrow=c(2,2))
  ...
  plot(date_time,power_data$Global_active_power,type="l",ylab="Global Active Power",xlab="")
  ...
  legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty = 1,col=c("black","red","blue"),xjust=1,yjust = 1,bty="n")
